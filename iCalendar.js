class iCalendar {
    constructor(config = {}) {
        ...
        this.eventsTemplate = config.eventsTemplate || false;
        this.eventsClick = config.eventsClick || false;
                ...
                if (this.displayMode === 'week' || this.displayMode === 'day') {
                    ...
                    if (findMatchSlot) {
                        ...
                        block.onclick = () => {
                            ...
                            this.timeSlots.querySelectorAll('.ievent').forEach(event => event.style.zIndex = 1);
                            if (currentzIndex === '1') {
